    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white text-slate-900">
        ...
        <div className="max-w-6xl mx-auto px-4 py-16 md:py-24 grid md:grid-cols-2 gap-10 items-center">
          <motion.div initial={{opacity:0,y:10}} animate={{opacity:1,y:0}} transition={{duration:0.5}}>
            ...
            <h1 className="mt-4 text-4xl md:text-5xl font-bold leading-tight">
              Reparación de <span className="text-slate-900">Neveras</span> <span className="text-slate-500">Lavadoras y Más</span>
            </h1>
      ...
      <section id="servicios" className="py-12 md:py-16 bg-slate-50 border-t border-slate-200">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <p className="mt-2 text-slate-600">Reparamos todas las marcas y modelos de Neveras, Lavadoras y Secadoras. Piezas originales y garantía.</p>
      ...
      <section className="py-12 md:py-16 bg-slate-50 border-y border-slate-200">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="mt-6 grid sm:grid-cols-2 md:grid-cols-4 gap-3 text-sm">
            {["El Poblado", "Laureles‑Estadio", "Belén", "Itagüi", "Rio Negro", "San Antornio de Prado", "Envigado/Sabaneta", "La Estrella y Más"].map((z,i)=>(
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="mt-6 space-y-3">
            {[
              ...
              {q:"💸 ¿Cuánto cuesta el diagnóstico?", a:(<>
              <p>El diagnóstico tiene un costo de <strong>$50.000</strong>, el cual cubre la visita del técnico, revisión completa del equipo y presupuesto detallado.</p>
              <p className="mt-2">👉 Si decides realizar la reparación con nosotros, <strong>no pagas el diagnóstico</strong>. <strong>Este valor nos ayuda a cubrir el desplazamiento, herramientas y tiempo del especialista.</strong></p>
              <p className="mt-2">🔹 También contamos con un <strong>diagnóstico turbo (en 60 minutos) por $100.000</strong>, ideal si necesitas una atención prioritaria y resultados inmediatos.</p>
              </>)},
